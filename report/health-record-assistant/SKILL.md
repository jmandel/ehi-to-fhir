...
description: |
  Connect to a user's health records from their patient portal via SMART on FHIR.
  Use when the user wants to access or ask questions about their personal health data.
---

# Health Record Assistant

Fetch and work with electronic health records from patient portals using SMART on FHIR.

## When to Use

- User wants to access, review, or work with their health records
- User wants to understand or has questions about their medical data
...
2. **Adjust to the patient** - Match their preferred language and level of detail.
3. **Respect privacy** - Data is temporary and session-based.
